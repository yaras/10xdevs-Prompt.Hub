// <copyright file="PromptEntity.cs" company="PromptHub">
...
/// <summary>
/// Represents a row in the <c>Prompts</c> Azure Table.
/// </summary>
public sealed class PromptEntity : ITableEntity
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the row is soft-deleted.
    /// </summary>
